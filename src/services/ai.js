...
【最高準則】：若連續三次都生成「古蹟、文物、歷史人物」，將被視為失職。請大膽跨越到「現代社會」、「未來想像」或「幽微人性」。
【嚴格禁止】：絕對不要生成「網路論壇」、「留言板」、「Q&A問答」這類格式，因為已經出太多次了。
請從以下【會考常見題材與文本形式】中，**隨機且跳躍式地挑選**（絕對不要重複常見的今昔對比或夾敘夾議）：
1. **生活應用類 (應用文/圖表)**：例如：新式桌遊說明書、馬拉松交管公告、老屋改裝募資企劃、米其林密探評鑑報告、捷運遺失物招領流程。
2. **未來科技與趨勢 (說明/議論)**：例如：AI 倫理的辯論、虛擬實境對學習的影響、外太空殖民的法律問題、社交媒體的心理成癮機制解析、永續發展與零碳生活。
3. **心理成長與哲理 (記敘/抒情/議論)**：例如：關於「放棄」的藝術、一場失敗後的內心獨白、針對「平庸」的禮讚、在繁忙都市中尋找寧靜的散文詩、人物傳記中鮮為人知的轉折時刻。
4. **校園與社會觀察 (記敘/應用文)**：例如：一位匿名畢業生的告解、關於校園空間改造的公聽會摘要、鄰里之間的一場小紛爭、針對「博愛座」現象的影評或讀者來信。
5. **科學與纪實 (說明文/圖表)**：例如：極端氣候下的動植物遷移、基因編輯的科普介紹、甚至是一份「研究深海大王烏賊的經費申請書」。
