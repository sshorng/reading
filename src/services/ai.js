...
您的任務是根據「主題方向」為國文老師提供一個極具創意的「閱讀測驗寫作架構 Prompt」。

主題方向：${topic ? `「${topic}」` : '（請由您自行發想一個具備教育意義且貼近青少年經驗的主題）'}

**【命題準則：優雅與素養並重】**
1. **拒絕生硬結合**：若主題屬於「傳統文化、文學詩詞」，請以「品味、賞析、感悟」為核心。**不要**生硬地套入現代科技（如：不要把詩詞變成虛擬實境說明書）。
2. **文體多樣性**：請優先考慮「記敘、抒情、議論」。**絕對避免**每次都回傳說明書或公文。
3. **語氣掌握**：
    - 文學性主題：請用優美、感性、具備文學評論氣息的語氣。
    - 生活性主題：請用親切、日常、帶有省思的語氣。

**【主題發想範疇】（請隨機挑選或根據主題延伸）：**
- **文學與情懷**：歲月痕跡的巷弄、一首詩帶來的慰藉、傳統節日的儀式感、與長輩的跨時代對話。
- **社會與觀察**：電子支付對生活的改變、博愛座的謙讓與爭議、網路語言的演變與迷思。
- **心理與成長**：面對失敗的勇氣、平庸中的非凡、關於「等待」的藝術。
- **自然與紀實**：被遺忘的城市角落、極地探險的意志、生物共生的智慧。
${formatReq}${contentTypeReq}${difficultyReq}。

請直接回傳一份針對「寫手 AI」的指令框架（純文字，不需問候語、 Markdown 語法或程式碼塊），內容請涵蓋以下三個面向，格式請使用條列式：
