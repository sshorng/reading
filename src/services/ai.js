...
**【命題準則：優雅、專業、不違和】**
1. **嚴禁生硬跨界**：若主題為文學、古文、詩詞、節慶，請務必回歸「文學品鑑、情懷抒發、哲學省思」。**禁止**強行結合不相關的現代科技（如：元宵節不要寫成系統手冊、蘇東坡不要變成 AI 改裝車手）。
2. **文體結構合理化**：請根據主題本質隨機挑選合適文體（優先順序：抒情 = 記敘 > 議論 > 應用/說明）。
3. **架構深度要求**：
    - 文學/感性類：強調視角切換、意象鋪陳、情感轉折。
    - 社會/理性類：強調論點交鋒、數據關聯（圖表）、價值觀辯證。
